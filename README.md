...
Additionally the code for the project can be found in ['Bank_Term_Deposit_Project.ipynb'](https://github.com/JaW02/term_subscription_project/blob/main/Bank_Term_Deposit_Project.ipynb)
